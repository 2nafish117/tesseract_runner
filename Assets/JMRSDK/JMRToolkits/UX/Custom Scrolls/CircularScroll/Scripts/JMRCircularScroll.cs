...
namespace JMRSDK.Toolkit
{
    public class JMRCircularScroll : MonoBehaviour, ISwipeHandler, IFocusable
    {
        ...
        [SerializeField] private GameObject scrollEnableRaycastTarget;
        ...
        private void OnEnable()
        {
            ...
            //enable scroll buttons if using gaze and click
            if (JMRRigManager.Instance.getDeviceID() != 2)
            {
                scrollEnableRaycastTarget.SetActive(true);
            }
            else
            {
                scrollEnableRaycastTarget.SetActive(false);
            }
        }
        ...
        /// <summary>
        /// Fills the current list with the items
        /// </summary>
        ...
        /// <summary>
        /// Returns a valid item with given index
        /// </summary>
        ...
        //Todo : Remove unwanted functions
        private void Update()
        {
        }
