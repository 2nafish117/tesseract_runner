...
namespace JMRSDK.Toolkit
{
    ...
    public class JMRNestedInfiniteScroll : MonoBehaviour, IDropHandler
    {
        ...
        /// Cached Scroll items
        /// </summary>
       private class CacheScrollElementData
        {
        ...
        /// <summary>
        /// Collection of cached scroll items
        /// </summary>
       ...
       private void UpdateHorizontal()
        {
            ...
            // Calculation of Item position and get the border value from first item position and first item width 
       ...
       private IEnumerator InitVertical(int count)
        {
        ...
        /// </summary>
        /// <param name="count">Item count</param>
       private IEnumerator InitHorizontal(int count)
        {
            while (!finishedSpawning)
            {
                yield return new WaitForEndOfFrame();
      ...
      private void ApplyDataToVertical(int count, int newCount, Direction direction)
       ...
       private IEnumerator CreateViews()
        ...
        /// </summary>
       private IEnumerator CreateViewsVertical()
        {
        ...
        /// </summary>
       private IEnumerator CreateViewsHorizontal()
        {
            if (currentPrefab == Prefab)
            {
                yield return null;
       ...
       private void CreateLabelsHorizontal()
        ...
        /// <summary>
        /// Get an Gameobject from the pooled objects
        /// </summary>
