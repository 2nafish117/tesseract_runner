...
public class JMRSpaceEffect : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //                item.anchoredPosition = Vector2.Lerp(item.anchoredPosition, new Vector2(j_Items[item.gameObject.GetInstanceID()].x + (val * spaceFactor), item.anchoredPosition.y), 4 * Time.deltaTime);
        //            }
        //        }
        //    }
        //}
